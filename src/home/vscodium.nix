...
in
{
  programs.vscodium = {
    ...
    profiles.default.userSettings = {
      ...
      # nixd needs to be told what to complete against; see nixd.nix for what
      # goes in here and why. nix-ide forwards this table to the server as-is.
      "nix.serverSettings".nixd = config.local.nixd.settings;
